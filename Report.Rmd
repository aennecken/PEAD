...
pred.table$V2 <- as.character(pred.table$V2)
pred.table$V2[pred.table$V2 == "UGAD"] <- "Gastroesophageal Origin"
...
predicted_sex <- getSex(mSetSq)
sex <- predicted_sex$predictedSex
sampleinfo <- cbind(sampleID,sentrix,chiptype,sex)
colnames(sampleinfo)<- c("Sample ID","Sentrix ID","Array Type","Predicted Gender")
...
Philipp Jurmeister, Anne Schoeler, Alexander Arnold, Frederick Klauschen, Dido Lenze, Michael Hummel, Leonille Schweizer, Hendrik Blaeker, Berit Pfitzner, Soulafa Mamlouk, Christine Sers, Carsten Denkert, Damian Stichel, David Horst, Maximilian von Laffert, David Capper

### Disclaimer  
Disclaimer: The provided algorithm was designed for use with pulmonary, colorectal and upper gastrointestinal adenocarcinomas. It has not been validated and should be used with caution. Implementation of the results in a clinical setting is in the sole responsibility of the treating physician.